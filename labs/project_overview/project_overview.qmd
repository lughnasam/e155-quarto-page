...
The FPGA will use its onboard DSP sampling system to sample the guitar’s signal at 8x the standard audio sampling rate (44100 KHz) to avoid aliasing in our signal. After this, it will apply relevant transformations to our signal, specifically reverb and chorus, before sending the signal over SPI communications to our MCU for further processing and output.
